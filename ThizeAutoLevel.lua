...
function _AutoupdaterMsg(msg) print("<b><font color=\"#FF0000\">Thize Auto Level:</font></b> <font color=\"#FFFFFF\">"..msg.."</font>") end
if AUTOUPDATE then
	local ServerData = GetWebResult(UPDATE_HOST, "/thize06/bol/master/Thize%20Auto%20Level%20Spells.version")
	if ServerData then
		ServerVersion = type(tonumber(ServerData)) == "number" and tonumber(ServerData) or nil
		if ServerVersion then
			if tonumber(version) < ServerVersion then
				_AutoupdaterMsg("Nova versao Disponivel "..ServerVersion)
				_AutoupdaterMsg("Atualizando, porfavor nao aperte F9")
				DelayAction(function() DownloadFile(UPDATE_URL, UPDATE_FILE_PATH, function () _AutoupdaterMsg("Sucesso ao Atualizar ("..version.." => "..ServerVersion.."), aperte F9 para carregar a versao mais nova") end) end, 3)
			else
				_AutoupdaterMsg("Voce tem a versao mais recente ("..ServerVersion..")")
			end
		end
	else
...
function OnLoad()
	print("<b><font color=\"#FF0000\">Thize Auto Level:</font></b> <font color=\"#FFFFFF\">Carregando...</font>"..version)
	...
	print("<b><font color=\"#FF0000\">Thize Auto Level:</font></b> <font color=\"#FFFFFF\">Sucesso ao Carregar - Seja Bem Vindo..!</font>")
end
